...
PROGRESS_FILE = "/Users/dave-macstudio/Desktop/tenis-zebricky/.scraper_leto_progress.txt"
...
print("Mažu letní data...")
sb.table("turnaje_hrace").delete().eq("sezona", "2026-L").execute()
sb.table("zapasy_hrace").delete().eq("sezona", "2026-L").execute()
